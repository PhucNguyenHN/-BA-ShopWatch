...
public interface BillRepository extends JpaRepository<Bill, Integer>{
	...
	@Query("select new com.shopwatch.api.controller.result.BillResult(b.id, b.fullname, b.phone, b.email, b.address, b.total_money, b.status_bill, b.create_at) from Bill b where b.cart.user = ?1")
